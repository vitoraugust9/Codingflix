...
exports.coursesController = {
    ...
    show: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const course = yield courseService_1.courseService.findByIdWithEpisodes(id);
            if (course) {
                const liked = yield likeService_1.likeService.isLiked(course.id, userId);
                const favorited = yield favoriteService_1.favoriteService.isFavorited(course.id, userId);
