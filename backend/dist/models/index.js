...
Course_1.Course.hasMany(Favorite_1.Favorite, { as: 'favoritesUsers', foreignKey: 'courseId' });
...
User_1.User.hasMany(Favorite_1.Favorite, { as: 'favoritesCourses', foreignKey: 'UserId' });
